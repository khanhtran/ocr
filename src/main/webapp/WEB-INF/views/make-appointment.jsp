		...
		<form:form  modelAttribute="newAppointment" class="form-horizontal"  >
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="employeeNumber"> Appointment Number</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="City">Category</label>
					<div class="col-lg-10">
						<div class="form:input-prepend">
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="State">Doctor</label>
					<div class="col-lg-10">
						<div class="form:input-prepend">
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="State">Date</label>
					<div class="col-lg-10">
						<div class="form:input-prepend">
							<form:input id="State" path="address.state" type="text" class="form:input-large"/>
							<form:errors path="address.state" cssClass="text-danger"/>
 				...
 				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnAdd" class="btn btn-primary" value ="Check"/>
					</div>
				</div>
